...
import SikostikDataSeeder from "./pages/SikostikDataSeeder";
      ...
      <AuthProvider>
        <SatkerConfigProvider>
          <TooltipProvider>
            ...
            <Route path="/sikostik28/seeder" element={<ProtectedRoute><Layout><SikostikDataSeeder /></Layout></ProtectedRoute>} />
