// App.tsx - VERSI DIPERBAIKI DENGAN LOGIKA KENAIKAN JENJANG YANG SPESIFIK
...
class AngkaKreditCalculator {
  ...
  // Cek apakah ini kenaikan jenjang (ganti jabatan + pangkat) - VERSI LEBIH SPESIFIK
  ...
  static hitungEstimasiKenaikan(karyawan: Karyawan, predikatAsumsi: number = 1.00): EstimasiKenaikan {
    ...
    // HANYA untuk kenaikan jenjang spesifik, kebutuhan pangkat = kebutuhan jabatan
