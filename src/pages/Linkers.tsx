...
export default function Linkers() {
  return <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold text-red-500">Linkers</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        return <Card key={link.title} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer border-border bg-card" onClick={() => window.open(link.url, "_blank", "noopener,noreferrer")}>
