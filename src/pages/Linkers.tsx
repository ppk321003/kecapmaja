  ...
  return <div className="min-h-screen bg-background p-0 m-0">
      <div className="w-full px-6 py-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="font-bold text-red-500 text-3xl">Linkers</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          ...
          return <Card key={link.title} className="group hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 cursor-pointer border-border bg-card h-full flex flex-col min-h-[140px]" onClick={() => window.open(link.url, "_blank", "noopener,noreferrer")}>
                ...
                <CardContent className="p-4 pt-0 flex-grow">
                  <CardDescription className="leading-relaxed line-clamp-2 text-base">
                    {link.description}
                  </CardDescription>
                </CardContent>
              </Card>;
