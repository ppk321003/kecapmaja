...
const linksData = [
  { title: "Photo of The Days", url: "https://photos.app.goo.gl/iW3WMUxLArYMK8HV8", description: "Apabila foto tidak dapat ditampilkan, silakan menghubungi Admin Kecap Maja untuk proses pendaftaran akses.", icon: Image },   
