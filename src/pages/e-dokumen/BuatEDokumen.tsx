  ...
  return (
    <div className="space-y-8 p-6">
      <div className="text-center space-y-3">
        <h1 className="text-4xl font-bold text-gray-800">Buat e-Dokumen</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {eDokumenMenuItems.map((item, index) => {
          ...
          return (
            <Card 
              key={item.title} 
              className={`hover:shadow-lg transition-all duration-300 flex flex-col border-2 ${colorClasses.border} hover:scale-105`}
            >
              ...
              <CardContent className="pt-0 mt-auto">
                <Button 
                  ...
                  className={`w-full ${colorClasses.button} text-white font-medium py-2.5 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg`}
                  size="lg"
                >
                  Buat Dokumen
                </Button>
