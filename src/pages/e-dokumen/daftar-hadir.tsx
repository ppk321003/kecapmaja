...
const DependentSelect: React.FC<{
  value: string;
  onValueChange: (value: string) => void;
  parentValue?: string;
  sheetName: string;
...
}> = ({ value, onValueChange, parentValue, sheetName, placeholder, disabledPlaceholder }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const rows = await fetchSheetData(CONSTANTS.SPREADSHEET.SOURCE_ID, `${sheetName}!A:D`);
    ...
    fetchData();
  }, [parentValue, sheetName, fetchSheetData]);
  ...
  return (
    <SearchableSelect
      ...
      options={options}
      placeholder={parentValue ? placeholder : disabledPlaceholder}
                  ...
                  <Controller 
                    ...
                    render={({ field }) => (
                      <DependentSelect 
                        ...
                        parentValue={watchedProgram}
                        sheetName={CONSTANTS.SHEET_NAMES.KEGIATAN}
                        placeholder="Pilih kegiatan"
                        disabledPlaceholder="Pilih program terlebih dahulu"
                      />
                    )} 
                  />
                  ...
                  <Controller 
                    ...
                    render={({ field }) => (
                      <DependentSelect 
                        value={field.value}
                        onValueChange={field.onChange}
                        parentValue={watchedKegiatan}
                        sheetName={CONSTANTS.SHEET_NAMES.KRO}
                        placeholder="Pilih KRO"
                        disabledPlaceholder="Pilih kegiatan terlebih dahulu"
                      />
                    )} 
                  />
                  ...
                  <Controller 
                    ...
                    render={({ field }) => (
                      <DependentSelect 
                        value={field.value}
                        onValueChange={field.onChange}
                        parentValue={watchedKRO}
                        sheetName={CONSTANTS.SHEET_NAMES.RO}
                        placeholder="Pilih RO"
                        disabledPlaceholder="Pilih KRO terlebih dahulu"
                      />
                    )} 
                  />
                  ...
                  <Controller 
                    ...
                    render={({ field }) => (
                      <DependentSelect 
                        value={field.value}
                        onValueChange={field.onChange}
                        sheetName={CONSTANTS.SHEET_NAMES.KOMPONEN}
                        placeholder="Pilih komponen"
                        disabledPlaceholder="Pilih komponen"
                      />
                    )} 
                  />
                  ...
                  <Controller 
                    ...
                    render={({ field }) => (
                      <DependentSelect 
                        value={field.value}
                        onValueChange={field.onChange}
                        sheetName={CONSTANTS.SHEET_NAMES.AKUN}
                        placeholder="Pilih akun"
                        disabledPlaceholder="Pilih akun"
                      />
                    )} 
                  />
