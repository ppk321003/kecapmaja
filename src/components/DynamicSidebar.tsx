...
const DynamicSidebar: React.FC<DynamicSidebarProps> = ({
  ...
  if (isLoading) {
    return (
      <aside className="fixed inset-y-0 left-0 z-50 w-94 transform bg-sidebar text-sidebar-foreground shadow-lg transition-transform duration-300 lg:static lg:translate-x-0">
