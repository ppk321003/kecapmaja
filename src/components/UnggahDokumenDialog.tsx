...
export function UnggahDokumenDialog() {
  ...
  // Fetch Master Organik data saat dialog dibuka
  ...
  const uploadToGoogleDrive = async () => {
    ...
    try {
      ...
      // Reset form dan tutup dialog setelah 2 detik
      setTimeout(() => {
        setFormData({
          jenisDokumen: "",
          judul: "",
        ...
        const fileInput = document.getElementById("dialog-file-input") as HTMLInputElement;
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          {/* File Upload */}
          <div className="space-y-2">
            <Label htmlFor="dialog-file-input">
              ...
              <label htmlFor="dialog-file-input" className="cursor-pointer">
                {formData.file ? (
                  <div className="space-y-2">
                    ...
                    <p className="font-semibold text-green-700 text-sm">{formData.file.name}</p>
