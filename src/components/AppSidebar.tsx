...
import { ScrollArea } from "@/components/ui/scroll-area"; // Import ScrollArea yang sudah dimodifikasi
...
const eDokumenSubItems = [
  ...
  { title: "Kertas Kerja (Excel)", url: "https://drive.google.com/drive/folders/1MUBorF7HngfDpQPaPZC_wIIcH9cN_AU1", icon: FileSpreadsheet, external: true },
  { title: "Kertas Kerja (PDF)", url: "https://drive.google.com/drive/folders/1bP4d3iQ61ogw6z1G9hoiIwFXw5DhH40P", icon: FileType, external: true },
];
...
export function AppSidebar() {
  ...
  return (
    ...
    >
      {/* Gunakan ScrollArea untuk wrap konten */}
