...
export default function ResetStatusSPKBAST() {
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      const APPS_SCRIPT_URL = `https://script.google.com/macros/s/AKfycbyNzPtKOL3COYIF5lQAg01RSa-D0rkn9ExQhQVLge1GD7j132cezS5e9G5nWNwXJ7U/exec?action=resetStatus&periode=${encodeURIComponent(periodeToReset)}`;
