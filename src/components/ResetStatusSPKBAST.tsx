...
export default function ResetStatusSPKBAST() {
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      const APPS_SCRIPT_URL = `https://script.google.com/macros/s/AKfycbz9IUT4qwZ_5uEZeUVmhWb7kKO5PhkUwuSw-VccngDa7CRUQ9OGuGKnk38BW9P_O957/exec?action=resetStatus&periode=${encodeURIComponent(periodeToReset)}&spreadsheetId=${encodeURIComponent(spreadsheetId)}`;
