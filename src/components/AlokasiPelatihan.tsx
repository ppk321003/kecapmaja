...
export function AlokasiPelatihan() {
  ...
  if (isLoading) {
    return (
      <Card className="border-t-4 border-t-blue-500">
        <CardHeader>
          <CardTitle className="text-lg">👥 Alokasi Pelatihan</CardTitle>
        </CardHeader>
  ...
  return (
    <Card className="border-t-4 border-t-blue-500">
      <CardHeader>
        <CardTitle className="text-lg">👥 Alokasi Pelatihan</CardTitle>
        <CardDescription>Data alokasi pelatihan dari Google Sheets (View Only)</CardDescription>
      </CardHeader>
      <CardContent>
